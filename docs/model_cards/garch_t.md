...
|:--|--:|--:|:--:|--:|:--:|--:|:--:|
| BTC | 0.01 | 0.011 | FAIL | -0.06 | yes | 10/18 | yes |
| BTC | 0.025 | 0.026 | pass | -0.03 | yes | 7/18 | yes |
| ETH | 0.01 | 0.010 | pass | +0.07 | yes | 2/18 | yes |
| ETH | 0.025 | 0.028 | FAIL | -0.07 | yes | 3/18 | yes |

**Density (Berkowitz):** BTC p=0.972, ETH p=0.784

**Volatility forecast (QLIKE):** BTC rank 8/15 (MZ b=0.96), ETH rank 8/15 (MZ b=0.71)
