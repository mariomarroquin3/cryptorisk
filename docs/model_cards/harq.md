...
|:--|--:|--:|:--:|--:|:--:|--:|:--:|
| BTC | 0.01 | 0.023 | FAIL | -1.96 | no | 20/20 | yes |
| BTC | 0.025 | 0.035 | FAIL | -0.79 | no | 19/20 | yes |
| ETH | 0.01 | 0.023 | FAIL | -1.72 | no | 18/20 | yes |
| ETH | 0.025 | 0.036 | FAIL | -0.73 | no | 12/20 | yes |

**Density (Berkowitz):** BTC p=0.000 (reject), ETH p=0.000 (reject)

**Volatility forecast (QLIKE):** BTC rank 2/17 (MZ b=0.61), ETH rank 1/17 (MZ b=0.67)

**Decision layer:** BTC capital $430,112 (m_c 1.90), N* $1,458,028; ETH capital $436,271 (m_c 1.50), N* $1,135,063
